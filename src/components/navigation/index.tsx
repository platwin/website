...
const links = [
    ...
    },
    {
        label: `Docs`,
        href: `/`,
        link: 'https://docs.platwin.io/nash-market/nash-market'
    },
    {
        label: `Blog`,
        href: `/`,
...
const MobileMenu = () => (
    <div className={tw(`md:hidden`)}>
        <div className={tw(`px-2 pt-2 pb-3 space-y-1 sm:px-3`)}>
            {links.map((link: Link) => (
                <a href={link.link || link.href} className={tw(`text-gray-500 block px-3 py-2 text-base font-medium`)} key={link.label}>
                    {link.label}
                </a>
            ))}
        </div>
                ...
                <div className={tw(`flex items-center justify-between h-24`)}>
                    ...
                    <div className={tw(`hidden md:block`)}>
                        <div className={tw(`ml-4 flex items-center md:ml-6`)}>
                            <Button primary onClick={() => { }}>Launch App</Button>
                        </div>
                    </div>
